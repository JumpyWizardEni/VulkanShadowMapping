...
const int NUM = 4;
const int MODELS_COUNT = 12;
const int SCALES[12] = {5, 500, 20, 5, 5, 500, 20, 5, 5, 500, 20, 5};
bool keys[1024];
...
const std::vector<std::string> TEXTURES = {"models/wood.png", "models/metal.jpg", "models/pink.jpg", "models/statue"
                                                                                                     ".jpg"};
const std::array<float, 12> offsetsX = {0, -0.5, -1, -0.3, -2, -0.1, -0.2, -0.3, 1, 0.2, 3, 4};
const std::array<float, 12> offsetsY = {0, 3, 1, 2, -0.3, -2, -0.1, -0.2, -0.3, 1, 0.2, 3};
const std::array<float, 12> offsetsZ = {0, 0, 0.5, 0.2, -2, -0.1, -0.2, -0.3, 1, 0.2, 3, 4};
