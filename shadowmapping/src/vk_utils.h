...
namespace vk_utils
{
  ...
  void CreateSwapChain(VkPhysicalDevice a_physDevice, VkDevice a_device, VkSurfaceKHR a_surface, int a_width, int a_height,
  ...
  void CreateScreenFrameBuffersForDepth(VkDevice a_device, std::vector<VkFramebuffer> &framebuffer, VkRenderPass a_renderPass,
                                        ScreenBufferResources* pScreen,
